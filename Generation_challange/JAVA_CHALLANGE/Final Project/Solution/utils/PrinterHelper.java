...
public class PrinterHelper
{
        ...
        throws ParseException
    {
        ...
        while (!validDateFormat) {
            ...
            try {
                birthDate = formatter.parse(birthDateInput);
                validDateFormat = true;
            } catch (ParseException e) {
                System.out.println("Invalid date format! Please enter the birth date in MM/dd/yyyy format:");
            }
        }
